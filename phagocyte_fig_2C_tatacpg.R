...
#   (gene_table$pig_log2FoldChange-gene_table$mouse_log2FoldChange)^2   +
#   (gene_table$pig_log2FoldChange-gene_table$rat_log2FoldChange)^2   +
#   (gene_table$pig_log2FoldChange-gene_table$rabbit_log2FoldChange)^2
#   )   )
# 
# write.csv(gene_table, file = "phagocyte_data/phagocytes_summary_data.csv")
...
pdf("output_figures/fig_2C_tata_phago.pdf", width = 2.5, height = 3,useDingbats = F)
print(box_gg)
dev.off()
...
pdf("output_figures/fig_2C_cpg_phago.pdf", width = 2.5, height = 3,useDingbats = F)
print(box_gg)
dev.off()
